...
(function() {
                    ...
                    if (e.f_ == o) {
                        ...
                        e.getTilesUrl = function(b, d) {
                            var e = b.x,
                                ...
                                l = 1;
                            this.map.Fx() && (l = 2);
                            l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=20170706&scale=" + l + "&ak=" + qa;
    ...
    Yc.getTilesUrl = function(a, b, c) {
        ...
        return (Wc[Math.abs(d + a) % Wc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + e + (6 == x.da.la ? "&color_dep=32&colors=50" : "") + "&udt=20170706").replace(/-(\d+)/gi, "M$1")
    };
    var Ma = new Uc("\u5730\u56fe", Yc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
    ...
    $c.getTilesUrl = function(a, b) {
        var c = a.x,
            d = a.y;
        return (Vc[Math.abs(c + d) % Vc.length] + "u=x=" + c + ";y=" + d + ";z=" + b + ";v=009;type=sate&fm=46&udt=20170704").replace(/-(\d+)/gi, "M$1")
    };
    var Za = new Uc("\u536b\u661f", $c, {
            tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
            minZoom: 1,
    ...
    ad.getTilesUrl = function(a, b) {
        var c = a.x,
            d = a.y;
        return (Wc[Math.abs(c + d) % Wc.length] + "?qt=tile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (d + "").replace(/-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == x.da.la ? "&color_dep=32&colors=50" : "") + "&udt=20170630").replace(/-(\d+)/gi, "M$1")
    };
