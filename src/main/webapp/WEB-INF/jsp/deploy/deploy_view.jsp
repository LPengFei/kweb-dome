...
<div class="plan-verify-wrap">
    ...
    <div class="section verify">
        <div class="tile-header">
            <h4>详情</h4>
            <a class="btn " data-url="/app/deploy/edit?tabid=y_deploy-list&amp;mid=131" data-toggle="navtab" data-id="deploy-edit" data-title="新增发布管理" style="background: #14CAB4; color: white; float: right;margin-right:20px;">新增</a>
        </div>
        <form>
