...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/kconf/menu/parent_index" method="post">
		...
		<div class="bjui-searchBar ess-searchBar">
			...
			<button type="button"  data-url="${ctx}/kconf/menu/edit?type=module" data-icon="plus" data-toggle="navtab" data-id="menu-module-edit" data-title="新增模块" style="background: #14CAB4; color: white; float: right;"  >新增模块</button>
			<%--<div class="pull-right">
				<div class="btn-group" style="margin-top:-2px;">
					<button type="button" class="btn-default dropdown-toggle" data-toggle="dropdown" data-icon="copy">批量操作<span class="caret"></span></button>
					<ul class="dropdown-menu right" role="menu">
						<li><a href="${ctx}/kconf/menu/export?export=true&xlsid=358" class="export" data-toggle="dialog" data-confirm-msg="确定要导出相应模板吗？" class="blue">菜单配置-导出</a></li>
						<li class="divider"></li>
						<li><a href="${ctx}/kconf/menu/importxls?xlsid=357"  data-toggle="dialog" data-width="500" data-height="200" data-id="dialog-normal" class="green">菜单配置-导入</a></li>
		...
		<tbody>
			<c:forEach items="${page.list }" var="r" varStatus="s">
				<tr>
					...
					<td class="center">${r.mname }</td>
					<td class="center">${r.ord }</td>
					<td class="center">
						<a style="color:red;"  data-toggle="doajax"  data-confirm-msg="删除该数据时会将其菜单下所有子菜单信息一起删除，确定要删除该行信息吗？" href="${ctx }/kconf/menu/delete?id=${r.menuid}">删除</a>  
						&nbsp;&nbsp;
 						<a href="${ctx}/kconf/menu/edit?id=${r.menuid}"  style="color:green;"  data-toggle="navtab" data-id="menu-parent-edit" data-title="编辑菜单" >修改</a>
 						&nbsp;&nbsp;
 						<a href="${ctx}/kconf/menu/parent_index?pmenuid=${r.menuid}"  style="color:#0275D2;"  data-toggle="navtab" data-id="menu-parent-list" data-title="配置${r.mname }" >配置子菜单</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
