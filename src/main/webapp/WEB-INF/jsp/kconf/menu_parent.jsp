...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/kconf/menu/parent_index" method="post">
		...
		<div class="bjui-searchBar ess-searchBar">
			...
			<button type="button"  data-url="${ctx}/kconf/menu/edit?pmenuid=${pmenuid}&type=parent" data-icon="plus" data-toggle="navtab" data-id="menu-parent-edit" data-title="新增菜单" style="background: #14CAB4; color: white; float: right;"  >新增</button>
		</div>
	</form>
			...
			<c:forEach items="${page.list }" var="r" varStatus="s">
				<tr>
					...
					<td class="center">
						...
						&nbsp;&nbsp;
 						<a href="${ctx}/kconf/menu/edit?id=${r.menuid}&type=parent"  style="color:green;"  data-toggle="navtab" data-id="menu-parent-edit" data-title="编辑菜单" >修改</a>
 						&nbsp;&nbsp;
 						<a href="${ctx}/kconf/menu/child_index?pmenuid=${r.menuid}"  style="color:#0275D2;"  data-toggle="navtab" data-id="menu-child-list" data-title="配置${r.mname }" >配置子菜单</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
