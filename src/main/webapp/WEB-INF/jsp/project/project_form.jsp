	...
	<div class="ess-form">
		<form id="common_form" action="${ctx}/${appid }/${modelName }/save"  data-toggle="validate" data-alertmsg="false">
			...
			<ul>
				...
				<li class="input_text" style="">
					<label for="j_input_city">
						所属地市
					</label>
					<span class="wrap_bjui_btn_box" style="position: relative; display: inline-block;"><input
							type="text" name="record.city" id="j_input_city" style="padding-right: 15px;" value=""
							placeholder="请输入所属地市" data-rule="" data-ds="" data-toggle="lookup" data-chk-style="false"
							data-form-style="" data-live-search="false"
							data-url=""
							data-group="record" data-width="800" data-height="400" data-title=""
							data-select-empty-text="---请选择---" readonly="" class="form-control" title=""><a
							class="bjui-lookup" href="javascript:;" data-toggle="lookupbtn"
							style="height: 28px; line-height: 28px;" data-title=""><i
