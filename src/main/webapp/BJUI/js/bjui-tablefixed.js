...
+function ($) {
    ...
    Tablefixed.prototype.init = function() {
        ...
        this.options.styles = []
        this.$element.wrap('<div class="bjui-tablefixed wrap_tables clearfix"></div>')
    ...
    Tablefixed.prototype.initBody = function() {
        ...
        $tbody.wrap('<div class="fixedtableScroller  tableS_init"'+ style +' style="width:'+ (this.options.newWidth) +'px;"><div class="fixedtableTbody"><table style="width:'+ (this.options.newWidth - Tablefixed.SCROLLW) +'px; max-width:'+ (this.options.newWidth - Tablefixed.SCROLLW) +'px;"></table></div></div>')
