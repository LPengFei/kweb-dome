...
public class QRCodeUtil {
    ...
    public static void main(String[] args) {
        getQrcodeImg("http://m.55bbs.com/liren_2003609/", PropKit.get(IConstans.BASEUPLOADPATH).concat(File.separator).concat("sign").concat(File.separator).concat("2113.png"));
    }
}
