 ...
 * CaptchaRender.
 */
public class SecCaptchaRender extends Render {
	...
	public static SecCaptchaRender create(HttpServletRequest request, HttpServletResponse response){
		SecCaptchaRender captchaRender = new SecCaptchaRender();
		captchaRender.setContext(request, response);
		return captchaRender;
	}
	...
	public static void setCaptchaName(String captchaName) {
		...
		SecCaptchaRender.captchaName = captchaName;
	}
...
//		response.addCookie(cookie);
	...
	public BufferedImage getBufferedImage() {
		...
		CacheKit.put(captchaName, vCode, vCode);
		request.setAttribute(captchaName, vCode);
		return image;
	}
	...
	public static boolean validate(Controller controller, String userInputCaptcha) {
		...
		boolean result = userInputCaptcha.equals(CacheKit.get(captchaName, userInputCaptcha));
		CacheKit.remove(captchaName, userInputCaptcha);
